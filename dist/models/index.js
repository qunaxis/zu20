...
var _objectsToCsv = require('objects-to-csv');
...
const genHash = new _randomHash.RandomHash({
    length: 6,
    charset: 'ABCDEFGHKLMNPQRSTUVXYZ0123456789',
    rng: _crypto.randomBytes
});
...
const saveUrlCsv = async urlData => {
    const csv = new _objectsToCsv2.default(urlData);
...
const importDataToDb = async data => {
    ...
    let resultSettings = await db.Setting.bulkCreate([{ parameter: 'infected', value: '0' }, { parameter: 'timer', value: '15:00' }, { parameter: 'antidot', value: '0' }], {
